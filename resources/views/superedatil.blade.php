                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-8 col-sm-8">
                            <h1>{{ $supervisors->first_name }} {{ $supervisors->last_name }}</h1>
                        </div>
                                            ...
                                            <div class="event-detail">
                                                ...
                                                <div class="event-info row content-pad">
                                                    <div class="col-md-10 col-sm-10">
                                                        <h2 class="small-text">Name</h2>
                                                        <p>{{ $supervisors->first_name }} {{ $supervisors->last_name }}</p>
                                                        <h2 class="small-text">Email</h2>
                                                        <p>{{ $supervisors->email }}</p>
                                                        <h2 class="small-text">description</h2>
                                                        <p>{{ $supervisors->description }}</p>
                                                        <h2 class="small-text">department</h2>
                                                        <p>{{ $supervisors->department }}</p>

                                                        <h2 class="small-text">office_id</h2>
                                                        <p>{{( $supervisors->supervisorinfo) ? $supervisors->supervisorinfo->office_id  : ''}}</p>
                                                        <h2 class="small-text">college</h2>
                                                        <p>{{( $supervisors->supervisorinfo) ? $supervisors->supervisorinfo->college  : ''}}</p>
                                                        <h2 class="small-text">Specialization</h2>
                                                        <p>{{( $supervisors->supervisorinfo) ? $supervisors->supervisorinfo->Specialization  : ''}}</p>
                                            ...
                                            <div class=" widget-inner">
                                                <div class="un-heading un-separator">
                                                    <div class="un-heading-wrap">
                                                        ...
                                                        <span
                                                            class="un-heading-line un-heading-after"><span></span></span>
                                                    </div>
