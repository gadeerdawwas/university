...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="{{ asset('asset/site/logo-removebg-preview.png') }}">
...
<body>
	<header>
		<div class="container">
			<h2><img src="{{ asset('asset/site/logo-removebg-preview.png') }}" width="60px" alt=""></h2>
			<nav>
				<a href="#">Home</a>
                ...
                <a href="{{ route('supervisor.index') }}"> {{ Auth::user()->first_name }}</a>
                @endif
                @if(auth()->user()->is_student == 0)
                <a href="{{ route('student.index') }}"> {{ Auth::user()->first_name }}</a>
                @endif
                @if(auth()->user()->is_student == 2)
                <a href="{{ route('GPcommittee.index') }}"> {{ Auth::user()->first_name }}</a>
                @endif
