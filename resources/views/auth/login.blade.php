            ...
            <div class="">
                ...
                <div class="col col-login mx-auto ">
                    <div class="text-center">
                        <a href="index.html"><img src="{{ asset('asset/site/logo-removebg-preview.png') }}" width="80px" class="header-brand-img" alt=""></a>
                    </div>
                </div>
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="tab5">
                                            ...
                                            <form method="POST" action="{{ route('login') }}">
                                                ...
                                                <div class="row mb-3">
                                                    <label for="email"
                                                        class="col-md-5 col-form-label text-md-start">{{ __('Email Address') }}</label>
                                                ...
                                                <div class="row mb-3">
                                                    <label for="password"
                                                        class="col-md-5 col-form-label text-md-start">{{ __('Password') }}</label>
