            ...
            <div class="row">
                ...
                <div class="col-md-12 col-xl-12">
                                ...
                                <div class="form">
                                    ...
                                    <div class="form-group">
                                        <div class="form-group">
                                            ...
                                            <a href="{{ asset('upload/task/'.$task->id) }}" download="">download file</a>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('supervisor.resulttask',$task->id) }}" method="post" enctype="multipart/form-data">
                               @csrf
                                <div class="form">
                                    <input type="hidden" name="id" value="{{  $task->id }}">
                                    <div class="form-group">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="grade" value="{{ $task->grade }}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="form-group">
                                            ...
                                            <textarea name="note" class="form-control" id="" cols="30" rows="10">{{ $task->note }}</textarea>
                                        </div>
                                    </div>
                                </div>
