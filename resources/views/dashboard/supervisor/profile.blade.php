            ...
            <div class="row">
                ...
                <div class="col-xl-11">
                    <div class="card">
                        ...
                        <form action="{{ route('supervisor.info') }}" method="post"  enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label for="exampleInputnumber">college</label>
                                <input type="text" class="form-control" name="college" value="{{ (($info ? $info->college : '')) }}" id="exampleInputnumber" required>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputnumber">Specialization</label>
                                <input type="text" class="form-control" name="Specialization"  value="{{ (($info ? $info->Specialization : '')) }}" id="exampleInputnumber" required>
                            </div>
                            <div class="form-group">
