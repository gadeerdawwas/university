                                            ...
                                            @foreach ($projects as $project)
                                                <tr>
                                                    ...
                                                    <td class="text-nowrap align-middle">
                                                        ...
                                                        <a href="{{ asset('upload/project/' . $project->requirment) }}"
                                                            download>
                                                            Downlad file
                                                        </a>
                                                    </td>
                                                    <td class="text-nowrap align-middle">{{ $project->User->first_name }}
                                                        {{ $project->User->last_name }}</td>
                                                    ...
                                                    <td class="text-center align-middle">
                                                        ...
                                                        <div class="modal fade zoomIn"
                                                            id="deleteRecordModal{{ $project->id }}" tabindex="-1"
